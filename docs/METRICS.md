...
Boundary: Cryptographic integrity proof, not regulatory certification. Autonomous live execution exists but defaults off and requires VPS-side arming; the evidence set contains one historical live AAPLUSDT round-trip, while strategy results remain backtest/paper evidence.
